...
def sol_5_test(sol_5_dict):
    ...
    if sol_5_dict['The user that is most similar to user 1.'] == sol_5_dict_1['The user that is most similar to user 1.'] and sol_5_dict['The user that is the 10th most similar to user 131'] == sol_5_dict_1['The user that is the 10th most similar to user 131']:
